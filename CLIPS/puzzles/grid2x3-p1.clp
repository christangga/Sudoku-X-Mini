(defrule grid-values
	...
	(assert (possible (row 1) (column 6) (value 2)   (group 2) (diagonal 2) (id 9)))
	(assert (possible (row 2) (column 4) (value any) (group 2) (diagonal 0) (id 10)))
	(assert (possible (row 2) (column 5) (value any) (group 2) (diagonal 2) (id 11)))
	(assert (possible (row 2) (column 6) (value 4)   (group 2) (diagonal 0) (id 12)))
	...
	(assert (possible (row 4) (column 2) (value 5)   (group 3) (diagonal 0) (id 17)))
	(assert (possible (row 4) (column 3) (value 6)   (group 3) (diagonal 2) (id 18)))
	...
	(assert (possible (row 4) (column 5) (value 3)   (group 4) (diagonal 0) (id 23)))
	(assert (possible (row 4) (column 6) (value any) (group 4) (diagonal 0) (id 24)))

	(assert (possible (row 5) (column 1) (value 5)   (group 5) (diagonal 0) (id 25)))
	...
	(assert (possible (row 6) (column 4) (value 1)   (group 6) (diagonal 0) (id 34)))
	(assert (possible (row 6) (column 5) (value any) (group 6) (diagonal 0) (id 35)))
