...
(defrule naked-single-x
   ...
   (possible (value ?v) (diagonal ?d&:(> ?d 0)) (id ?id))
   
   (not (possible (value ~?v) (diagonal ?d&:(> ?d 0)) (id ?id)))
   
   (possible (value ?v) (diagonal ?d&:(> ?d 0)) (id ?id2&~?id))
...
(defrule naked-single-column
   ...
   (possible (value ?v) (column ?c) (id ?id)) ; cari yang value nya ga any
   
   (not (possible (value ~?v) (column ?c) (id ?id)))
   
   (possible (value ?v) (column ?c) (id ?id2&~?id)) ; cari dalam 1 kolom yang possible value nya sama kaya di atas
